...
# ╔═╡ 4ef4afac-461f-11ef-0370-1576ec1f06ae
using DICOM, NativeFileDialog, Dates, DelimitedFiles
...
begin
	...
	for row in axes( my_raw_dict, 1)
		...
		println( string( dcm_tag, base=16, pad=8), "\t", my_raw_dict[row, 3])
	end
end
...
manifest_format = "2.0"
project_hash = "5bef71565eb00d8a919bcc4981d734990fd9c1d2"
